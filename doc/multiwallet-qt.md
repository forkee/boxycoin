...
Only requiring some minor changes is boxycoin.cpp.
...
Changes to boxycoin.cpp
----------------------
boxycoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
