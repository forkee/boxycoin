...
RESOURCES += src/qt/boxycoin.qrc src/qt/boxycoin_locale.qrc
TRANSLATIONS += src/qt/locale/boxycoin_bg.ts \
                src/qt/locale/boxycoin_de.ts \
                src/qt/locale/boxycoin_en.ts \
                src/qt/locale/boxycoin_es.ts \
                src/qt/locale/boxycoin_fi.ts \
                src/qt/locale/boxycoin_fr.ts \
                src/qt/locale/boxycoin_it.ts \
                src/qt/locale/boxycoin_ja.ts \
                src/qt/locale/boxycoin_pl.ts \
                src/qt/locale/boxycoin_pt.ts \
                src/qt/locale/boxycoin_ru.ts \
                src/qt/locale/boxycoin_sk.ts \
                src/qt/locale/boxycoin_sv.ts \
                src/qt/locale/boxycoin_vi.ts \
                src/qt/locale/boxycoin_zh_CN.ts \
                src/qt/locale/boxycoin_zh_TW.ts
