...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BoxyCoin Core"),
     ...
     * override -datadir in the boxycoin.conf file in the default data directory
     * (to be consistent with boxycoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
