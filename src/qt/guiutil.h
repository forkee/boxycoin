...
/** Utility functions used by the BoxyCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Render BoxyCoin addresses in monospace font
    ...
    // Parse "boxycoin:" URI into recipient object, return true on successful parsing
