    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BoxyCore") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BoxyCore"), this);
    aboutAction->setStatusTip(tr("Show information about BoxyCore"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BoxyCoin"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the BoxyCore help message to get a list with possible BoxyCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BoxyCore client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BoxyCoin network", "", count));
}
...
{
    QString strTitle = tr("BoxyCore"); // default title
