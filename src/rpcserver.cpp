...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* BoxyCoin features */
    { "boxycoin",               "masternode",             &masternode,             true,      true,       false },
    { "boxycoin",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "boxycoin",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "boxycoin",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "boxycoin",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "boxycoin",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "boxycoin",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "boxycoin",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use boxycoind, or the -server option to boxycoin-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleRpc(string methodname, string args){
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
        "\"method\": \"" + methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:21523/\n";
}
